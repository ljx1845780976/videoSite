...
//    ============================== List ==============================
    ...
    /**
     * 将值 value 按正序插入键为 key 的 list 中，如果 list 不存在则创建空 list
     * @param key 键
     * @param value 值
     * @return true / false
     */
    ...
    /**
     * 将值 value 按逆序插入键为 key 的 list 中，如果 list 不存在则创建空 list
     * @param key 键r
     * @param value 值
     * @return true / false
     */
    ...
    /**
     * 将值 value 按正序插入键为 key 的 list 中，并设置时间
     * @param key 键
     * @param value 值
     * @param time 时间
     * @return true / false
    ...
    /**
     * 将值 value 按逆序插入键为 key 的 list 中，并设置时间
     * @param key 键
     * @param value 值
     * @param time 时间
     * @return true / false
